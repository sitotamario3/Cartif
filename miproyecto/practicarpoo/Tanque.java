...
public class Tanque extends Vehiculo {
    private int calibreCañon;

    public Tanque(String nombre, int velocidadMaxima, int blindaje, int calibreCañon){
        super(nombre, velocidadMaxima, blindaje);
        this.calibreCañon = calibreCañon;
    }

   
    @Override
    public void describir() {
        System.out.println("Tanque "+ super.getNombre() + " desplegado en posición de combate");
    }
